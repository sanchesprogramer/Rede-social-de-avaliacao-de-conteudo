import './Navbar.css'
import r2d2 from '../imgs/Loogo.png'
...
const pages = ['Filmes', 'Livros', 'Séries'];
    ...
    <AppBar sx={{background: "#54141d"}} position="static">
      <Container background-color="#54141d" maxWidth="xl">
        ...
        <img className='logo' src={r2d2} alt=""  />
          ...
          <Typography sx={{marginRight:"10px"}}> Pesquisar:</Typography>
          <Input sx={{marginRight:"10px", background: "#ffffff", borderRadius: 2}}></Input>
          <SearchIcon></SearchIcon>

          <Box sx={{ marginLeft:"40px", flexGrow: 0 }}>
